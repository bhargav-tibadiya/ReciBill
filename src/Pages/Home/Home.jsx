...
const Home = () => {
  return (
    <div className={styles.home_container}>
      <div className={styles.bg_animation}>
      ...
      <div className={styles.main_heading}>
        <h1>
          Generating Receipts were <br />
          <span className={styles.main_heading__highlight}>
            Never Been Easier</span> Before
        </h1>
      </div>
      <div className={styles.main_desription}>
        <h2>But not now,Try Recibill</h2>
        <h3>Easiest way to Generate Bill or Receipt for you business according to your Style and Convenient</h3>
      </div>
    </div>
  )
}
